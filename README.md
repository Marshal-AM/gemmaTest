# Voice Agent (Gemma 4 + Daily + Deepgram)

Real-time voice bot that listens via Daily.co, reasons over speech with **google/gemma-4-E2B-it**, and responds via **Deepgram Aura** TTS.
...
| `DEEPGRAM_API_KEY` | Yes | Deepgram API key (Aura TTS) |
| `DEEPGRAM_VOICE` | No | Aura voice (default `aura-2-helena-en`) |
